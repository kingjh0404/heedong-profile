...
export function PortfolioSidebar() {
  ...
  return (
    <aside className="hidden md:flex w-64 border-r bg-card/50 backdrop-blur-sm flex-col sticky top-0 h-screen">
      <div className="p-4 sm:p-6 border-b">
        <h2 className="text-base sm:text-lg font-bold">About Me</h2>
      </div>
              ...
              <li key={item.href}>
                <Link href={item.href}>
                  <Button
                    ...
                    className={cn("w-full justify-start text-sm", isActive && "bg-primary text-primary-foreground")}
                  >
